...
import com.project.shoppingcartapp.controller.ProductsController;
...
public class ProductControllerTest {
    ...
    void setUp() {
        ...
        shoppingCart.setSerialNumber("Shopping-Cart-Test");
    ...
    void testGetAllProducts() throws Exception {
        when(productRepo.findAll()).thenReturn(productList.subList(0, 1));
